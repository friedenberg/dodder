...
func (config *TomlV1Private) GetImmutableConfig() BlobPrivate {
	return config
}

func (config *TomlV1Private) GetImmutableConfigPublic() BlobPublic {
	return &TomlV1Public{
...
func (config *TomlV1Public) GetImmutableConfigPublic() BlobPublic {
	return config
}
